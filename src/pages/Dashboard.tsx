...
import CollaboratorsManagement from '@/components/dashboard/CollaboratorsManagement';
...
const ServiceStatusManagement = lazy(() => import('@/components/dashboard/ServiceStatusManagement'));
...
export default function Dashboard() {
  ...
  const renderView = () => {
    ...
    switch (currentView) {
      ...
      case 'collaborators':
        return isAdmin ? <CollaboratorsManagement /> : <CommercialVisitsManager />;
      case 'users':

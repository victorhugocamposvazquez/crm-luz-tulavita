...
const PROVIDER_LOGOS: { name: string; className: string }[] = [
  ...
  {
    name: "Iberdrola",
    className: "text-lg sm:text-xl font-medium tracking-tighter",
  },
...
function ProviderLogoMarquee() {
  ...
  const logoClass = (p: (typeof PROVIDER_LOGOS)[0]) =>
    cn(
      "select-none whitespace-nowrap text-neutral-500 [filter:grayscale(1)]",
      p.className,
    );
  ...
  return (
    <>
      ...
      <div
        className="motion-reduce:hidden w-full overflow-hidden py-2 sm:py-2.5"
        style={fadeMask}
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          <div className="mx-auto flex w-full max-w-lg flex-col items-center pb-8 text-center sm:pb-10">
              ...
              >
                <div className="flex min-h-0 items-start justify-between gap-2 sm:gap-3">
                  <div className="flex min-w-0 flex-1 items-start gap-3 sm:gap-4">
                    ...
                    >
                      <Check
                        className="h-6 w-6 text-neutral-900 sm:h-7 sm:w-7"
                        strokeWidth={2.25}
                      />
                    </span>
                    <div className="min-w-0 flex-1 pt-0.5 pr-1">
                      ...
                      <p
                        className="mt-0.5 truncate text-sm text-neutral-600"
            ...
            <div className="my-7 flex w-full max-w-md items-center gap-3 sm:my-9">
              ...
              <span className="whitespace-nowrap px-2 text-xs text-neutral-500 sm:text-sm">
                o si no la tienes
              </span>
              <div className="h-px flex-1 bg-neutral-200" />
            </div>
            ...
            <div className="mt-6 w-full sm:mt-7">
              <AhorroLuzReviewsStrip
                rating={4.89}
                reviewCount={750}
                className="px-0 pt-0"
              />
              <p className="sr-only">
                Comparativa con numerosas comercializadoras, entre otras Endesa,
                Naturgy, Iberdrola, Repsol, Octopus y Plenitude.
              </p>
              <div aria-hidden>
                <ProviderLogoMarquee />
              </div>
